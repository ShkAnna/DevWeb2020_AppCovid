...
public class SQLConnector {
    ...
    public Connection connection() {
        ...
        try {
            ...
            System.out.println("Pilotes jdbc ne dÈmarre pas");
            System.exit(-1);
        }
        try {
            ...
            System.out.println("Connection ‡ la BDD impossible");
            System.exit(-1);
        }
        return con;
    }
    ...
    public void adressAlreadyExist(String address) throws Exception {
        ...
        ResultSet result = doRequest(query);
        if (result.next()) {
            throw new Exception(address + " est est dÈja utilisÈ pour un lieu existant");
        }
        this.closeCon();
    }
