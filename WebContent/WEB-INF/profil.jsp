...
<div class="container bootstrap snippet">
    <div class="row">
    	...
    	<div class="col-sm-2"><a href="logout-servlet" class="pull-right"><img  class="img-circle img-responsive" src="http://www.gravatar.com/avatar/28fd20ccec6865e2d5f0e1f4446eb7bf?s=100"></a></div>
    </div>
    <div class="row">
      ...
      <div class="text-center">
        ...
        <input type="file" class="text-center center-block file-upload">
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body"><a >Négatif</a></div>
          </div>
