				...
				<div class="row justify-content-between" style="margin-top: 1rem !important;margin-bottom: 1rem !important;margin-right: 0rem !important;">
					...
					<div class="col-3">
						<div class="row justify-content-end">
							 <a class="col-6 left-sign text-center"  aria-selected="false" href="sign-up-user">Sign up</a> 
							<a class="col-6 right-sign text-center"  aria-selected="true" href="sign-in-user">Sign in</a>		
						</div>
					</div>
				</div>
