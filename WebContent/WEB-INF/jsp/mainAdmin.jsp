    ...
    <nav class="side-navbar">
      <div class="side-navbar-wrapper">
        ...
        <div class="sidenav-header d-flex align-items-center justify-content-center">
          <!-- User Info-->
          <div class="sidenav-header-inner text-center"><img src="${pageContext.request.contextPath}/resources/img/avatar-7.jpg" alt="person" class="img-fluid rounded-circle">
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            ...
            <li><a href="${pageContext.request.contextPath}/WEB-INF/forms.html"> <i class="icon-form"></i>Forms                             </a></li>
            <li><a href="${pageContext.request.contextPath}/WEB-INF/charts.html"> <i class="fa fa-bar-chart"></i>Charts                             </a></li>
            <li><a href="${pageContext.request.contextPath}/WEB-INF/tables.html"> <i class="icon-grid"></i>Tables                             </a></li>
            ...
            <li><a href="${pageContext.request.contextPath}/WEB-INF/login.html"> <i class="icon-interface-windows"></i>Login page                             </a></li>
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                ...
                <li class="nav-item dropdown"><a id="languages" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link language dropdown-toggle"><img src="img/flags/16/GB.png" alt="English"><span class="d-none d-sm-inline-block">English</span></a>
                  <ul aria-labelledby="languages" class="dropdown-menu">
                    <li><a rel="nofollow" href="#" class="dropdown-item"> <img src="${pageContext.request.contextPath}/resources/img/flags/16/DE.png" alt="English" class="mr-2"><span>German</span></a></li>
                    <li><a rel="nofollow" href="#" class="dropdown-item"> <img src="${pageContext.request.contextPath}/resources/img/flags/16/FR.png" alt="English" class="mr-2"><span>French                                                         </span></a></li>
                  </ul>
                </li>
                <!-- Log out-->
                <li class="nav-item"><a href="${pageContext.request.contextPath}/WEB-INF/login.html" class="nav-link logout"> <span class="d-none d-sm-inline-block">Logout</span><i class="fa fa-sign-out"></i></a></li>
              </ul>
            </div>
          </div>
        </nav>
                    ...
                    <ul class="feed-elements list-unstyled">
                      ...
                      <li class="clearfix">
                        <div class="feed d-flex justify-content-between">
                          <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="${pageContext.request.contextPath}/resources/img/avatar-5.jpg" alt="person" class="img-fluid rounded-circle"></a>
                      ...
                      <li class="clearfix">
                        <div class="feed d-flex justify-content-between">
                          <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="${pageContext.request.contextPath}/resources/img/avatar-2.jpg" alt="person" class="img-fluid rounded-circle"></a>
                      ...
                      <li class="clearfix">
                        <div class="feed d-flex justify-content-between">
                          <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="${pageContext.request.contextPath}/resources/img/avatar-3.jpg" alt="person" class="img-fluid rounded-circle"></a>
                      ...
                      <li class="clearfix">
                        <div class="feed d-flex justify-content-between">
                          <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="${pageContext.request.contextPath}/resources/img/avatar-1.jpg" alt="person" class="img-fluid rounded-circle"></a>
                      ...
                      <li class="clearfix">
                        <div class="feed d-flex justify-content-between">
                          <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="${pageContext.request.contextPath}/resources/img/avatar-6.jpg" alt="person" class="img-fluid rounded-circle"></a>
